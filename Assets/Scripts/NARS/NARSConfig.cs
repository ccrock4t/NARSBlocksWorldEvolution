...
public class NARSConfig {
    ...
    /*z
        System Parameters
    */
    public float k = 1;  // evidential horizon
    public float T = 0.51f;  // decision rule (goal decision-making) threshold
    ...
    */
    ...
    public float PROJECTION_DECAY_EVENT = 0.8f;
    ...
    public float PRIORITY_DECAY_VALUE = 0.99f; // value in [0,1] weaken band w/ priority during priority decay
    public float PRIORITY_STRENGTHEN_VALUE = 0.99f;  // priority strengthen bor multiplier when concept == activated

    /*
        Bags
    */
    public int BAG_DEFAULT_CAPACITY = 10000; // default for how many items can fit in a bag
