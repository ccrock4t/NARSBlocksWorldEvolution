...
public class CompositionRules
{
    ...
    public Sentence DisjunctionOrIntensionalIntersection(Sentence j1, Sentence j2)
    {
        ...
        */
        ...
        if (j1_statement.get_predicate_term() == j2_statement.get_predicate_term())
        {
        ...
        else if (j1_statement.get_subject_term() == j2_statement.get_subject_term())
        {
            ...
            if (j1_statement.get_predicate_term() is CompoundTerm || j2_statement.get_predicate_term() is CompoundTerm)
            {
                // don't compound terms which are already compound
                // this reduces complexity.
                // todo better simplifying of syntactically complex results
