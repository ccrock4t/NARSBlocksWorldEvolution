...
public class SyllogisticRules
{
    ...
    public Sentence Deduction(Sentence j1, Sentence j2)
    {
        ...
        */
        ...
        StatementTerm result_statement = new StatementTerm(j2_statement.get_subject_term(), j1_statement.get_predicate_term(), j1_statement.get_copula());
    ...
    public Sentence Analogy(Sentence j1, Sentence j2)
    {
        ...
        */
        ...
        // Statement
        if (j1_statement.get_subject_term() ==j2_statement.get_predicate_term())
        {
            // j1=M-->P, j2=S<->M
            result_statement = new StatementTerm(j2_statement.get_subject_term(), j1_statement.get_predicate_term(), j1_statement.get_copula()); // S-->P
        }

        else if (j1_statement.get_subject_term() ==j2_statement.get_subject_term())
        {
            // j1=M-->P, j2=M<->S
            result_statement = new StatementTerm(j2_statement.get_predicate_term(), j1_statement.get_predicate_term(), j1_statement.get_copula()); // S-->P
        }
        else if (j1_statement.get_predicate_term() ==j2_statement.get_predicate_term())
        {
            // j1=P-->M, j2=S<->M
            result_statement = new StatementTerm(j1_statement.get_subject_term(),j2_statement.get_subject_term(), j1_statement.get_copula()); // P-->S
        }
        else if (j1_statement.get_predicate_term() ==j2_statement.get_subject_term())
        {
            // j1=P-->M, j2=M<->S
            result_statement = new StatementTerm(j1_statement.get_subject_term(),j2_statement.get_predicate_term(), j1_statement.get_copula());  // P-->S
        }
        else
        {
    ...
    public Sentence Resemblance(Sentence j1, Sentence j2)
    {
        ...
        */
        ...
        {
            // j1=M<->P, j2=S<->M
            result_statement = new StatementTerm(j2_statement.get_subject_term(),
                                                              j1_statement.get_predicate_term(),
                                                              j1_statement.get_copula());  // S<->P
        }
        else if (j1_statement.get_subject_term() == j2_statement.get_subject_term())
        {
            // j1=M<->P, j2=M<->S
            result_statement = new StatementTerm(j2_statement.get_predicate_term(),
                                                              j1_statement.get_predicate_term(),
                                                              j1_statement.get_copula());  // S<->P
        }
        else if (j1_statement.get_predicate_term() == j2_statement.get_predicate_term())
    ...
    public Sentence Abduction(Sentence j1, Sentence j2)
    {
        ...
        */
        ...
        StatementTerm j2_statement = (StatementTerm)j2.get_statement_term();
        // Statement
        StatementTerm result_statement = new StatementTerm(j2_statement.get_subject_term(),
                                                          j1_statement.get_subject_term(),
                                                          j1_statement.get_copula());
    ...
    public Sentence Induction(Sentence j1, Sentence j2)
    {
        ...
        */
        ...
        StatementTerm j2_statement = (StatementTerm)j2.get_statement_term();
        // Statement
        StatementTerm result_statement = new StatementTerm(j2_statement.get_predicate_term(), j1_statement.get_predicate_term(), j1_statement.get_copula());
    ...
    public Sentence Exemplification(Sentence j1, Sentence j2)
    {
        ...
        */
        ...
        StatementTerm j2_statement = (StatementTerm)j2.get_statement_term();
        // Statement
        StatementTerm result_statement = new StatementTerm(j2_statement.get_predicate_term(), j1_statement.get_subject_term(), j1_statement.get_copula());
    ...
    public Sentence Comparison(Sentence j1, Sentence j2)
    {
        ...
        */
        ...
        StatementTerm result_statement;
        // Statement
        if (j1_statement.get_subject_term() == j2_statement.get_subject_term())
        {
            // M --> P && M --> S
