...
public class LocalRules
{
    ...
    public Sentence Revision(Sentence j1, Sentence j2)
    {
        ...
        */
        ...
        if (j1_statement is CompoundTerm && j1_statement.connector == TermConnector.SequentialConjunction)
        {
            List<int> new_intervals = new List<int>();

            CompoundTerm j1_compound = (CompoundTerm)j1_statement;
    ...
    public Sentence Choice(Sentence j1, Sentence j2, bool only_confidence=false)
    {
        ...
        */
        ...
        EvidentialValue j2_value = this.nars.inferenceEngine.get_sentence_value_time_decayed(j2);
    ...
    public bool Decision(Goal j)
    {
        ...
        */
        float desirability = j.get_desirability(this.nars);
    ...
    public Sentence Projection(Sentence j, int occurrence_time)
    {
        ...
        */
        ...
        EvidentialValue result_truth = this.nars.inferenceEngine.truthValueFunctions.F_Projection(j.evidential_value.frequency,
